# Socontra demo 3
# Use return received messages to a central orchestrator agent or function to process to simplify coding.
...
# ----- ORCHESTRATOR FUNCTION THAT MANAGES THE DIALOGUE (GAME) ----- #

def game_orchestrator(agent_name, distribution_list, message):
    ...
    while True:
        ...
        # socontra.my_guess_response is the endpoint function name specified in the protocol (socontra_message_protocol3.py).
        ...
        if guessed_number == random_number:
            ...
            if sender_agent == 'socontra_demo:helper_agent1':
...
if __name__ == '__main__':
    ...
    game_orchestrator(message_initiator, distribution_list, message=message)
