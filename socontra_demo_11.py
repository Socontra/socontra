...
# agent-to-agent transation or application, particularly the automation of commercial transactions by 
# Web Agents that replicate online stores to service other agents/bots.
