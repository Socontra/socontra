...
def receive_new_message(agent_name: str, received_message: Message):    
    ...
    # To reply, just pass in the last messages received with 'message_responding_to=', which comprises the agent name to
    # respond to, and references to both the specific dialogue and the (previous) protocol state/stage ('new_message').
    # The socontra.reply_message() will send a 'message_response' message, received by relevant endpoint below.
