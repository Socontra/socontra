...
if __name__ == '__main__':
    ...
    # For the Socontra allocate protocol, we use a central orchestrator, which we call below.
    # Refer to the two templates protocol_templates/service/socontra_allocate_protocol_consumer.py and
    # protocol_templates/service/socontra_allocate_protocol_supplier.py to see the types of commands/messages and the logic/stages of the protocol.
